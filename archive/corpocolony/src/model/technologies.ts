  ...
  [TechnologyIds.COMMUNICATIONS]: {
    ...
    branches: {
      netOps: {
        ...
        name: "NetOps",
        description:
          "Capabilities for accumulating and transmitting combat data in realtime",
      },
      sigInt: {
        id: "sigInt",
        name: "SIGINT",
  ...
  [TechnologyIds.INFANTRY]: {
    ...
    branches: {
      ...
      guerillaWarfare: {
        ...
        description:
          "Explosives, concealable weapon and other gadgets for operations behind the enemy lines.",
      },
    },
  },
  [TechnologyIds.TANKS]: {
    ...
    branches: {
      ...
      maintenanceComplexity: {
        ...
        description:
          "Complexity of supporting operations tank, via repairs and supplies necessary",
      },
      productionCost: {
        id: "productionCost",
        name: "Production cost",
  ...
  [TechnologyIds.ARTILLERY]: {
    ...
    branches: {
      targettingSystems: {
        ...
        description:
          "Radars, targeting computers, interactive maps and other measures that assist with aiming the shots",
      },
      explosivePayload: {
        id: "explosivePayload",
