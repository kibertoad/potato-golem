...
export const commonCreateInstance = (descriptor: CommonEntityDescriptor<CommonEntityInstanceContext>, context: CommonEntityInstanceContext) => {
...
export class Spawner<EntityDescriptor extends CommonEntityDescriptor<InstanceContext>, EntityInstance extends Entity<EntityDescriptor>, InstanceContext>{
    private idCounter: number
    private readonly entities: EntityInstance[]
    private readonly descriptorRegistry: Record<string, EntityDescriptor>;

    public constructor(entityList: EntityInstance[], descriptorRegistry: Record<string, EntityDescriptor>) {
