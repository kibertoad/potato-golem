...
export { BulletDescriptor, BulletEntity, BulletEntityContext } from './src/prefabs/entities/BulletEntity'
...
export { CommonEntityInstanceContext, CommonEntityDescriptor, commonCreateInstance, Spawner } from './src/spawners/Spawner'
