...
export function doShapesIntersect(shape1: any, shape2: any): boolean {
  ...
  if (
    (shape1.type === 'Sprite' || shape1.type === 'Rectangle' || shape1.type === 'rexImageBox') &&
    (shape2.type === 'Sprite' || shape2.type === 'Rectangle' || shape1.type === 'rexImageBox')
  ) {
    return Phaser.Geom.Intersects.RectangleToRectangle(shape1 as any, shape2 as any)
  }

  if (
    (shape1.type === 'Circle' || shape1.type === 'Arc') &&
    (shape2.type === 'Circle' || shape2.type === 'Arc')
  ) {
